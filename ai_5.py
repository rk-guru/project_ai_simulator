...
def flash_tool_func(inlet_stream: dict,eq_name,stream_name) -> list: #outlet_temp_C :float,
    ...
    energy_dict = {
        ...
        'Equipment': eq_name,
        "Energy": 714}
    # df_stream1 = process_stream_data(outlet_stream1)
    # df_stream2 = process_stream_data(outlet_stream2)
    # df_energy = process_energy_stream_data(energy_dict)
    # df = pd.concat([df_stream1,df_stream2, df_energy], axis=1)
    # df = df.fillna('-')
    # Data_table = pd.concat([Data_table, df], axis=1)
